...
pub mod guess_entity_name {
    ...
    fn guess_entity_name_inner(
        ...
        let associations = &[
            ...
            ("bevy::pbr::light::PointLight", "PointLight"),
            ("bevy::pbr::light::DirectionalLight", "DirectionalLight"),
            ("bevy_text::text::Text", "Text"),
            ("bevy_ui::ui_node::Node", "Node"),
            ("bevy::asset::handle::Handle<bevy::pbr::pbr_material::StandardMaterial>", "Pbr Mesh"),
